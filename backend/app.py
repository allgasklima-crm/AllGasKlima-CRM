...
def create_order_extra_columns():
    connection = get_connection()
...
# =========================================================
# ΕΛΕΓΧΟΣ ΔΙΠΛΟΥ ΤΗΛΕΦΩΝΟΥ
# =========================================================

def find_customer_with_phones(
    phones,
...
def create_customer():
    ...
    duplicate = find_customer_with_phones(
            [
                customer_data[
                    "phone1"
                ],
...
def update_customer(
    ...
    return jsonify({
        ...
        "message":
            "Τα στοιχεία του πελάτη ενημερώθηκαν σωστά.",
...
def delete_call(
    ...
    return jsonify({
        ...
        "message":
            "Η κλήση μεταφέρθηκε στα διαγραμμένα."
    })
...
@app.get(
    "/api/customer/<int:customer_id>/history"
)
...
def save_scheduled_order():
    ...
    reminder_minutes = safe_non_negative_int(
            data.get(
                "reminder_minutes"
            ) or 30
        )
